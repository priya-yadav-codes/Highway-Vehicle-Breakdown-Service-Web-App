...
<div class="row"> 
   ...
   List<FeedbackDtls> list = dao.getAllFeedback(); 
   for(FeedbackDtls fb : list){
   %>
       <div class="col-md-3 col-sm-6">
         <div class="our-team">
           
           <h4 class="title"><%=fb.getName()%></h4>
            <b><hr><hr></b>
           <span class="post">
            <p><b>Email: </b><%=fb.getEmail() %></p> <!-- -->
            <p><b>Subject </b><%=fb.getSubject()%></p> <!-- -->
                      
            <p><b>Message: </b><%=fb.getMessage()%></p><!-- -->
           </span> 
         </div> 
      </div> 
